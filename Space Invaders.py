'''
Implementação simples de um jogo bem limitado onde os inimigos são inicializados com suas respectivas posições iniciais.
...
- Ao ser atingido, o inimigo explode em 4 círculos menores que continuam no jogo. Porém,
este processo acontece no máximo 2 vezes.
Uma linha contendo um inteiro M, seguida de M linhas descrevendo os M círculos iniciais.
Cada uma dessas M linhas contém o centro e o raio de cada círculo.
Por fim, uma linha contendo um inteiro N, seguida de N linhas descrevendo os N raios a
serem disparados em sequência. Cada uma dessas N linhas descreve um raio com 4
números reais que representam a origem e a direção do raio.
A saída do programa é um número inteiro representando a quantidade de círculos
sobreviventes após o disparo em sequência dos N raios.
